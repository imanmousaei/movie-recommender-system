...
def build_gui():
    ...
    if imdb_id:            
        ...
        your_title, your_year, your_plot, your_genre, your_awards, your_poster_path = get_movie_info(imdb_id)
        ...
        recommendations = get_clustering_recommendations(imdb_id, 'kmeans', num_recommendations=num_recommendations)
